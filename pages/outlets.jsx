  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse bias ratings and credibility scores for 112 major news outlets including BBC, CNN, Fox News, The Guardian and Wall Street Journal. See which outlets report fairly and which lean left or right." />
        ...
        <meta property="og:description" content="Browse bias ratings and credibility scores for 112 major news outlets. See which outlets report fairly and which lean left or right." />
        ...
        <meta name="twitter:description" content="Bias and credibility scores for 112 major news outlets — updated hourly." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'News Outlet Bias & Credibility Ratings — RatedNews',
            description: 'Browse bias ratings and credibility scores for 112 major news outlets including BBC, CNN, Fox News, The Guardian and Wall Street Journal.',
