  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse bias ratings and credibility scores for 100+ major news outlets including BBC, CNN, Fox News, The Guardian and Wall Street Journal. See which outlets report fairly and which lean left or right." />
        ...
        <meta property="og:description" content="Browse bias ratings and credibility scores for 100+ major news outlets. See which outlets report fairly and which lean left or right." />
        ...
        <meta name="twitter:description" content="Bias and credibility scores for 100+ major news outlets — updated hourly." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            description: 'Browse bias ratings and credibility scores for 100+ major news outlets including BBC, CNN, Fox News, The Guardian and Wall Street Journal.',
