...
export const CATEGORY_META = [
  {
    ...
    title: 'Political News Rated for Credibility & Bias',
    description: 'Political news from the UK, US and beyond — every story rated for credibility and bias by AI and community reviewers. Compare how outlets cover the same political events.',
  },
  {
    value: 'Business', slug: 'business', emoji: '📈',
    title: 'Business & Economy News Rated for Credibility',
    description: 'Business, markets and economic news rated for credibility — company results, inflation, interest rates and more across 50+ outlets.',
  },
  {
    value: 'Sport', slug: 'sport', emoji: '⚽',
    title: 'Sports News Rated for Credibility & Fairness',
    description: 'Sports news from around the world, rated for credibility and editorial fairness. Football, cricket, tennis, rugby and more — scored by AI and community reviewers.',
  },
  {
    value: 'Tech', slug: 'tech', emoji: '💻',
    title: 'Technology News Rated for Credibility',
    description: 'Technology news rated for credibility — AI, cybersecurity, startups, social media and innovation, compared across the outlets that cover them.',
  },
  {
    value: 'Science', slug: 'science', emoji: '🔬',
    title: 'Science News Rated for Credibility',
    description: 'Science and research news rated for credibility — space, biology, climate science and discoveries, scored by AI across multiple outlets.',
  },
  {
  ...
  },
  {
    ...
    title: 'Climate & Environment News Rated for Credibility',
    description: 'Climate and environment news rated for credibility — emissions, biodiversity, net zero policy and sustainability, compared across outlets with known bias ratings.',
  },
  {
    value: 'Entertainment', slug: 'entertainment', emoji: '🎬',
    title: 'Entertainment News Rated for Fairness',
    description: 'Entertainment news rated for credibility and fairness — film, TV, music, celebrities and awards, scored across outlets so you can spot editorial spin.',
  },
  {
    value: 'Crime', slug: 'crime', emoji: '🔍',
    title: 'Crime & Justice News Rated for Credibility',
    description: 'Crime and justice news rated for credibility and fairness across UK and US outlets — court cases, policing and legal proceedings, compared side by side.',
  },
  {
    value: 'Travel', slug: 'travel', emoji: '✈️',
    title: 'Travel News Rated for Credibility',
    description: 'Travel news and updates rated for credibility — airline disruption, visa changes, destination news and tourism policy across multiple outlets.',
  },
  {
    value: 'Education', slug: 'education', emoji: '🎓',
    title: 'Education News Rated for Credibility',
    description: 'Education news from schools, universities and policy — rated for credibility across UK and US outlets covering tuition, exams and teaching.',
  },
  {
    value: 'Conflict', slug: 'conflict', emoji: '⚔️',
    title: 'Conflict News Rated for Credibility',
    description: 'War and conflict coverage rated for credibility and fairness — Gaza, Ukraine, and global conflicts compared across outlets to reveal differing narratives.',
  },
  {
    value: 'World', slug: 'world', emoji: '🌍',
    title: 'World News Rated for Credibility & Bias',
    description: 'International news from around the world rated for credibility and political bias — compare how different outlets frame the same global events.',
  },
]
