  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse news by topic — Politics, Business, Tech, Health, Sport, Environment and more. Top stories from 150+ outlets, rated by the community for accuracy, bias and quality." />
