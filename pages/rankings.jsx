  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Which news outlets do readers trust most? RatedNews ranks 200+ UK, US and international outlets by community rating — real reader scores for accuracy, bias and quality." />
        ...
        <meta property="og:description" content="Which news outlets do readers trust most? RatedNews ranks 200+ outlets by community rating." />
        ...
        <meta name="twitter:description" content="200+ news outlets ranked by community rating — reader scores for accuracy, bias and quality." />
