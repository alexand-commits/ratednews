  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Search every news story across 200+ outlets by topic, person or event. Browse by category or explore what's trending right now." />
        ...
        <meta property="og:description" content="Search every news story across 200+ outlets by topic, person or event." />
