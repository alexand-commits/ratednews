  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="How RatedNews works: a community-rated news aggregator pulling top stories from 250+ outlets, where readers rate the news outlets they trust." />
        ...
        <meta property="og:description" content="A community-rated news aggregator pulling top stories from 250+ outlets, where readers rate the news outlets they trust." />
        ...
        <meta name="twitter:description" content="Community-rated news from 250+ outlets — readers rate accuracy, bias and quality." />
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: { '@type': 'Answer', text: 'RatedNews is a community-rated news aggregator that pulls top stories from 250+ UK, US and international news outlets and lets readers rate the news outlets they trust for accuracy, bias and quality.' },
              },
              {
                '@type': 'Question',
              ...
              },
              {
                ...
                acceptedAnswer: { '@type': 'Answer', text: 'RatedNews aggregates 250+ major news outlets including BBC, CNN, Fox News, The Guardian, The New York Times, Wall Street Journal, Daily Mail, Reuters, AP, and many more UK, US, and international sources.' },
              },
              {
                '@type': 'Question',
